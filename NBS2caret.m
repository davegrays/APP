...
mtype_in={'NBSprep/subgroups/'};%NBSprep/time2age %{'COMmats/'} %{'NBSprep/subgroups/'}; %{'NBSprep/','NBSprep/exclude0s_','COMmats/','COMmats/exclude0s'};
mtype_out={'ageFX_inASDmales_strengthens_'};%{'social_poscor_COM_loggedFX_'};%{'ranknormal_COM_'} %{'rbeh_negcor_COM_'}; %{'STREN_','exclude0s_STREN_','COM_','exclude0s_COM_'};
matpref='all_maleASD_COM_ranknormalscale125'; %72ASD_COMscale125_ranknormal_ %'all_maleASD_COM_ranknormalize_';%'ranknormal_123connectome_' %'all_maleASD_COM_ranknormalize_'; %'123connectome_'; 

UI.contrast.ui='[0 -1 0]'; %[0 1 0 0] for TYP>ASD (or M>F), [0 -1 0 0] for ASD>TYP (or F>M); [0 0 0 1] for positive behavior cor; [0 0 0 -1] for negative behavior cor;
UI.design.ui=[matdir 'NBSprep/design_files_behavior/all_maleASD_designANCOVA.txt']; %NBSprep/time2age/designANCOVA103_72ASD %'NBSprep/designANCOVA164_123male.txt' %'NBSprep/design_files_behavior/all_maleASD_designANCOVA_5factors_try2_ADI.txt' substitute '6factors_try2_social' for '5factors_try2_ADI' 
...
%% NBS - parameters
thresh=[3.25]; %F/t-stat thresholds in NBS
